...
class _$AppDependenciesImpl implements _AppDependencies {
  const _$AppDependenciesImpl({required this.appName});
  ...
  @override
  String toString() {
    return 'AppDependencies(appName: $appName)';
  }
...
abstract class _AppDependencies implements AppDependencies {
  const factory _AppDependencies({required final String appName}) =
      _$AppDependenciesImpl;
