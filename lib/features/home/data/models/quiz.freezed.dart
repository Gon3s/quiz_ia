...
abstract class $QuizModelCopyWith<$Res> {
  ...
  @useResult
  $Res call({String level, String subject, List<QuestionModel> questions});
}
...
class _$QuizModelImpl extends _QuizModel {
  ...
  @override
  String toString() {
    return 'QuizModel(level: $level, subject: $subject, questions: $questions)';
  }
  ...
  @JsonKey(ignore: true)
  @override
  int get hashCode => Object.hash(runtimeType, level, subject,
...
class _$QuestionModelImpl extends _QuestionModel {
  ...
  @override
  String toString() {
    return 'QuestionModel(question: $question, answers: $answers, correctAnswer: $correctAnswer, explanation: $explanation)';
  }
...
abstract class _QuestionModel extends QuestionModel {
  const factory _QuestionModel(
      ...
      required final String explanation}) = _$QuestionModelImpl;
